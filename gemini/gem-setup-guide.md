...
このファイル全体をそのままGemに貼り付ける必要はありません。

Gem作成時には、以下を使います。

- Gemの名前案：Gem名に使用
- 説明文：Gem description に使用
- Gems の指示欄に貼る文面：Gemの指示欄にコピーして使用
- 利用開始時のプロンプト例：Gem利用開始時のサンプルとして使用
- 参照するとよいリポジトリ内ファイル：必要に応じてチャットに貼り付けるファイル選びに使用
